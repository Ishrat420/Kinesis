...
vi.mock("@/lib/data/prisma", () => ({
  prisma: {
    notificationRead: { deleteMany: mocks.deleteMany }, notificationFirstSeen: { deleteMany: mocks.deleteMany }, object: { deleteMany: mocks.deleteMany }, attentionDismissal: { deleteMany: mocks.deleteMany },
    ...
    relationshipMapVersion: { deleteMany: mocks.deleteMany },
