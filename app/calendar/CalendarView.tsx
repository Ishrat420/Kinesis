    ...
    <div className="mx-auto max-w-[1720px]">
      ...
      <div className="relative mt-7">
        <div className="mb-4 grid grid-cols-[44px_1fr_44px] items-center rounded-2xl border border-zinc-200/80 bg-white px-3 py-3 shadow-sm md:mx-auto md:max-w-xl">
          ...
          <div className="text-center"><h2 className="text-xl font-semibold">{formatMonthHeading(selectedMonth)}</h2><button onClick={() => router.push(`/calendar?month=${monthParam(new Date())}`)} className="mt-0.5 text-xs font-semibold text-violet-600 hover:text-violet-800">Today</button></div>
