  ...
  return <div className="min-h-screen bg-[#f7f8fb] px-4 py-7 text-zinc-950 md:px-8 xl:px-10">
    <div className="mx-auto max-w-[1720px]">
      <header className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div><Link href="/" className="mb-4 inline-flex text-sm font-semibold text-zinc-500 hover:text-zinc-950">← Back to dashboard</Link><h1 className="text-[38px] font-semibold leading-none tracking-tight">Calendar</h1><p className="mt-3 text-zinc-500">Everything dated and intentionally scheduled, in one place.</p></div>
