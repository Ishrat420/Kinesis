...
import { EditDocumentModal } from "@/app/documents/EditDocumentModal";
          ...
          <div className="mt-6 grid gap-6 xl:grid-cols-3">
            ...
            <section className="rounded-3xl border border-zinc-200/80 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              ...
              <div className="mt-5 space-y-4">
                {timeline.map((item) => (
                  <div
                    key={item.title}
                    className="border-l border-zinc-200 pl-4"
                  >
            ...
            <section className="rounded-3xl border border-zinc-200/80 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              ...
              <div className="mt-5 rounded-2xl bg-zinc-50 p-4 text-sm leading-6 text-zinc-500">
                ...
                Keep renewal notes, application details, or related context
                here.
              </div>
            </section>
          </div>
