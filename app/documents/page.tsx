...
export default async function DocumentsPage() {
  const [documents, documentTypes, documentSummary, user, settings] = await Promise.all([
    getDocuments(),
    getDocumentTypes(),
    getDocumentSummary(),
    getCurrentUser(),
      ...
      <div className="max-w-7xl">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-3">
            <ManualDocumentButton documentTypes={documentTypes} ownerName={getUserDisplayName(user)} defaultReminderDays={settings.reminderLeadDays} />
