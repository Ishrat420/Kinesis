...
function customFieldValue(field: CustomField, options: KinesisLinkOption[]) { if (field.type !== "KINESIS_LINK") return field.value; return options.find((option) => option.targetType === field.targetType && option.targetId === field.targetId)?.label ?? "Linked record"; }
