...
export async function GET() {
  const [user, settings, documents, documentTypes, goals, goalUnits, people, relationships, customModules, attentionDismissals] = await Promise.all([
  ...
  return new Response(JSON.stringify({ exportedAt, user, settings, documents, documentTypes, goals, goalUnits, people, relationships, customModules, attentionDismissals }, null, 2), {
